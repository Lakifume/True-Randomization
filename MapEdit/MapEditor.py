...
class Main(QMainWindow):
    ...
    def initUI(self):
        ...
        shortcut = QAction("Shortcuts", self)
        shortcut.triggered.connect(self.shortcut)
        help.addAction(shortcut)
        
        reverse = QPushButton()
        reverse.setShortcut(QKeySequence(Qt.Key_D))
        reverse.setIcon(QIcon("Data\\reverse_icon.png"))
        reverse.setStyleSheet("background-color: #21222e")
        ...
        swap.setStyleSheet("background-color: #21222e")
        ...
        ignore_left.setStyleSheet("background-color: #21222e")
        ...
        ignore_right.setStyleSheet("background-color: #21222e")
        ...
        ignore_top.setStyleSheet("background-color: #21222e")
        ...
        ignore_bottom.setStyleSheet("background-color: #21222e")
        ...
        self.zoom_in.setStyleSheet("background-color: #21222e")
        ...
        self.showMaximized()
        self.setStyleSheet("color: #ffffff; font-family: Cambria; font-size: 18px")
    ...
    def shortcut(self):
        ...
        box.setText("Save/warp direction toggle: D\nSave/warp type toggle: T\nIgnore left transitions: Ctrl + Left\nIgnore right transitions: Ctrl + Right\nIgnore top transitions: Ctrl + Up\nIgnore bottom transitions: Ctrl + Down\nZoom in: Alt + Up\nZoom out: Alt + Down\nScroll sideways: Alt + Mouse Wheel")
        box.setStyleSheet("background-color: #21222e")
        box.exec()
